      ...
      <div class="relative flex w-full flex-col items-center">
        ...
        <div class="lg:column-gap spacing-t grid w-full grid-cols-12">
          ...
          >
            ...
            <p class="sr-only">
              A software engineer and frontend architect, crafting
              high-performance digital experiences for businesses worldwide.
            </p>
            <p
              v-html="whoAmI"
              id="whoAmI"
            ...
            <div class="relative origin-left overflow-hidden sm:scale-150">
              <div id="contact-btn" class="flex -translate-y-full">
                <!-- <Button
                  ...
                  label="Get in touch"
                /> -->
                <Button label="Get in touch" url="mailto:akereledavidd@gmail.com" />
              </div>
            </div>
          </div>
...
import { getAvailableForWorkDate, textSplitterIntoChar } from '@/functions';
  ...
  const whoAmI = ref(
    'A software engineer & frontend architect, crafting high-performance digital experiences and AI-powered solutions for businesses worldwide.',
  );
