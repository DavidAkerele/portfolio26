  ...
  >
    ...
    <div class="grid w-full grid-cols-12">
      <div class="col-span-7 place-content-center md:col-span-6">
        <h6 class="heading-3 sm:heading-2 leading-none font-bold">
          © {{ new Date().getFullYear() }} David Akerele <br />
          All rights reserved.
        </h6>
      </div>
      ...
      >
        <p class="heading-6 font-bold uppercase">David's Local time</p>
...
<script setup lang="ts">
  ...
  onMounted(() => {
    myLocalTime.value = moment.tz('Europe/London').format('h:mm:ss a');
    setInterval(() => {
      myLocalTime.value = moment.tz('Europe/London').format('h:mm:ss a');
    }, 1000);
