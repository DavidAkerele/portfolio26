  ...
  >
    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          With a passion for engineering and design, I take projects from
          ideation to launch — building scalable, intelligent digital products
          that create lasting impact for businesses and their users.
        </p>
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
            I'm an MSc Computer Science student based in Manchester, UK,
            specialising in frontend architecture, full-stack development, and
            AI-powered web experiences. I blend technical depth with a sharp eye
            for design to build software that both performs and delights.
            <br /><br />
            Outside of code, you'll find me exploring AI research, contributing
            to open-source projects, or sharing thoughts on tech and engineering
            on <i>&Xopf;</i>.
          </p>
        </div>
      </div>
